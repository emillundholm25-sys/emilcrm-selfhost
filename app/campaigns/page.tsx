...
export default function CampaignsPage() {
  ...
  return (
    <>
      <PageHeader
        title="Campaigns"
        subtitle="Each campaign is a self-contained pipeline with its own ICP"
        actions={
              ...
              return (
                ...
                >
                    ...
                    <div className="flex shrink-0 items-center gap-0.5">
                      ...
                      <button
                        onClick={() => {
                          ...
                          toast(c.status === "archived" ? "Campaign restored" : "Campaign archived");
                        }}
                  ...
                  <div className="mt-3 flex items-center gap-4 text-xs text-zinc-500">
                    ...
                    <span className="tabular-nums">{formatCurrency(s.open)} open</span>
                    {s.won > 0 && <span className="tabular-nums text-emerald-600">{formatCurrency(s.won)} won</span>}
                    <span className="tabular-nums">{s.meetings} mtg</span>
                  </div>
